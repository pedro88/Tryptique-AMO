...
io.on("connection", (socket) => {
  ...
  socket.on("choice", (logoId) => {
    if (logoId === "facebook") {
      ...
      io.emit("miseAJourEcrans", `Tu es respponsable de l'acte d'achat, mais le paiement peut être pris en charge par quelqu'un d'autre (tes parents, tes tuteurs) ou partagé.`);
    } else {
